    ...
    class << self
      ...
      def create_hash
        hash = {
          ...
          'ANDROID_11_0' => make_android_hash('Google Pixel 4', '11.0', APPIUM_1_9_1),
          'ANDROID_10_0' => make_android_hash('Google Pixel 4', '10.0', APPIUM_1_9_1),
          'ANDROID_9_0' => make_android_hash('Google Pixel 3', '9.0', APPIUM_1_9_1),
          'ANDROID_8_1' => make_android_hash('Samsung Galaxy Note 9', '8.1', APPIUM_1_9_1),
          'ANDROID_8_0' => make_android_hash('Google Pixel 2', '8.0', APPIUM_1_9_1),
          'ANDROID_7_1' => make_android_hash('Google Pixel', '7.1', APPIUM_1_9_1),
          'ANDROID_6_0' => make_android_hash('Google Nexus 6', '6.0', APPIUM_1_9_1),
          'ANDROID_5_0' => make_android_hash('Google Nexus 6', '5.0', APPIUM_1_9_1),
        ...
        add_android 'Google Pixel 4', '11.0', APPIUM_1_9_1, hash          # ANDROID_11_0_GOOGLE_PIXEL_4
        add_android 'Samsung Galaxy Note 9', '8.1', APPIUM_1_9_1, hash    # ANDROID_8_1_SAMSUNG_GALAXY_NOTE_9
        add_android 'Samsung Galaxy J7 Prime', '8.1', APPIUM_1_9_1, hash  # ANDROID_8_1_SAMSUNG_GALAXY_J7_PRIME
        add_android 'Samsung Galaxy Tab S4', '8.1', APPIUM_1_9_1, hash    # ANDROID_8_1_SAMSUNG_GALAXY_TAB_S4
        add_android 'Google Pixel', '8.0', APPIUM_1_9_1, hash             # ANDROID_8_0_GOOGLE_PIXEL
        add_android 'Google Pixel 2', '8.0', APPIUM_1_9_1, hash           # ANDROID_8_0_GOOGLE_PIXEL_2
        add_android 'Samsung Galaxy S9', '8.0', APPIUM_1_9_1, hash        # ANDROID_8_0_SAMSUNG_GALAXY_S9
        add_android 'Samsung Galaxy S9 Plus', '8.0', APPIUM_1_9_1, hash   # ANDROID_8_0_SAMSUNG_GALAXY_S9_PLUS
        add_android 'Samsung Galaxy Tab S3', '7.0', APPIUM_1_9_1, hash    # ANDROID_7_0_SAMSUNG_GALAXY_TAB_S3
        add_android 'Motorola Moto X 2nd Gen', '6.0', APPIUM_1_9_1, hash  # ANDROID_6_0_MOTOROLA_MOTO_X_2ND_GEN
        add_android 'Google Nexus 6', '6.0', APPIUM_1_9_1, hash           # ANDROID_6_0_GOOGLE_NEXUS_6
        add_android 'Samsung Galaxy S7', '6.0', APPIUM_1_9_1, hash        # ANDROID_6_0_SAMSUNG_GALAXY_S7
        add_android 'Google Nexus 6', '5.0', APPIUM_1_9_1, hash           # ANDROID_5_0_GOOGLE_NEXUS_6
        add_android 'Samsung Galaxy S6', '5.0', APPIUM_1_9_1, hash        # ANDROID_5_0_SAMSUNG_GALAXY_S6

...
# @step_input project_name [String] The name of the project directory to invoke the lambda in
Given("I invoke the {string} lambda in the {string} project") do |lambda_name, project_name|
  Maze::Aws::Sam.invoke("features/fixtures/#{project_name}", lambda_name)
end
...
# @step_input lambda_name [String] The name of the lambda to invoke
# @step_input project_name [String] The name of the project directory to invoke the lambda in
# @step_input event_name [String] The name of the event to call the lambda with
Given("I invoke the {string} lambda in the {string} project with the {string} event") do |lambda_name, project_name, event_name|
  Maze::Aws::Sam.invoke("features/fixtures/#{project_name}", lambda_name, "events/#{event_name}.json")
end
